(function() {
    ...
    shoppers.forEach(function(shoppers) {
        if (shoppers.amount > 200) {
            console.log(shoppers.name + ' has to pay $' + shoppers.amount + ' before discount, and $' + (shoppers.amount - (shoppers.amount * .12)) + ' after discount.');
        } else {
            console.log(shoppers.name + ' has to pay $' + shoppers.amount + ', he doesn\'t get a discount ):')
        }
    })
